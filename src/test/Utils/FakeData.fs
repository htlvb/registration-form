    ...
    [
        {
            ...
            Slots = [|
                { Time = DateTime(2024, 10, 15, 13, 0, 0); MaxQuantityPerBooking = Some 5; RemainingCapacity = Some 20 }
                { Time = DateTime(2024, 10, 15, 14, 0, 0); MaxQuantityPerBooking = None; RemainingCapacity = Some 15 }
                { Time = DateTime(2024, 10, 15, 15, 0, 0); MaxQuantityPerBooking = None; RemainingCapacity = Some 10 }
                { Time = DateTime(2024, 10, 16, 13, 0, 0); MaxQuantityPerBooking = None; RemainingCapacity = None }
                { Time = DateTime(2024, 10, 16, 14, 0, 0); MaxQuantityPerBooking = None; RemainingCapacity = Some 40 }
                { Time = DateTime(2024, 10, 16, 15, 0, 0); MaxQuantityPerBooking = None; RemainingCapacity = Some 50 }
            |]
        ...
        }
        {
            ...
            Slots = [|
                { Time = DateTime(2024, 12, 15, 13, 0, 0); MaxQuantityPerBooking = Some 1; RemainingCapacity = Some 15 }
                { Time = DateTime(2025, 1, 16, 8, 0, 0); MaxQuantityPerBooking = Some 1; RemainingCapacity = Some 20 }
            |]
