    ...
    [
        {
            ...
            Slots = [|
                { Time = DateTime(2024, 10, 15, 13, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = Some 5; RemainingCapacity = Some 20; CanRequestIfFullyBooked = false }
                { Time = DateTime(2024, 10, 15, 14, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = None; RemainingCapacity = Some 15; CanRequestIfFullyBooked = false }
                { Time = DateTime(2024, 10, 15, 15, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = None; RemainingCapacity = Some 10; CanRequestIfFullyBooked = false }
                { Time = DateTime(2024, 10, 16, 13, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = None; RemainingCapacity = None; CanRequestIfFullyBooked = false }
                { Time = DateTime(2024, 10, 16, 14, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = None; RemainingCapacity = Some 40; CanRequestIfFullyBooked = false }
                { Time = DateTime(2024, 10, 16, 15, 0, 0); Duration = None; ClosingDate = None; MaxQuantityPerBooking = None; RemainingCapacity = Some 50; CanRequestIfFullyBooked = false }
            |]
            RegistrationConfirmationMail = {
                Subject = "Anmeldung zum Tag der offenen Tür der HTL Vöcklabruck"
                ContentTemplate = "{{{FullName}}},\n\nvielen Dank für die Anmeldung zum Tag der offenen Tür der HTL Vöcklabruck am {{{Date}}}.\nAufgrund von COVID-19 bitten wir Sie, pünktlich um {{{Time}}} zu Ihrer persönlichen Führung zu erscheinen.\nBei Änderungswünschen oder im Falle einer Verhinderung bitten wir Sie außerdem, uns sobald wie möglich Bescheid zu geben.\nAntworten Sie dafür auf diese E-Mail bzw. kontaktieren Sie uns telefonisch unter 07672/24605.\n\nWir freuen uns, Sie bei uns begrüßen zu dürfen."
            }
        ...
        }
        {
            ...
            Slots = [|
                { Time = DateTime(2024, 12, 15, 13, 0, 0); Duration = None; ClosingDate = Some(DateTime(2024, 12, 9, 0, 0, 0)); MaxQuantityPerBooking = Some 1; RemainingCapacity = Some 1; CanRequestIfFullyBooked = true }
                { Time = DateTime(2025, 1, 16, 8, 0, 0); Duration = None; ClosingDate = Some(DateTime(2025, 1, 10, 0, 0, 0)); MaxQuantityPerBooking = Some 1; RemainingCapacity = Some 20; CanRequestIfFullyBooked = true }
                { Time = DateTime(2025, 1, 23, 8, 0, 0); Duration = None; ClosingDate = Some(DateTime(2025, 1, 17, 0, 0, 0)); MaxQuantityPerBooking = Some 1; RemainingCapacity = Some 0; CanRequestIfFullyBooked = true }
            |]
            RegistrationConfirmationMail = {
                Subject = "Anmeldung zum Programmierworkshop \"Let's code\""
            ...
            RequestConfirmationMail = Some {
                Subject = "Anfrage zum Programmierworkshop \"Let's code\""
