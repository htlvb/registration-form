  ...
  <div class="flex flex-col gap-2" :class="{ '[&:not(:last-child)]:pb-2 [&:not(:last-child)]:border-b': isShowingDetails }">
    <div class="flex items-center gap-2">
      ...
      <span>
        ...
        <a v-else class="px-2 py-2 cursor-pointer" title="Details anzeigen" @click="isShowingDetails = !isShowingDetails">
    ...
    <div v-if="isShowingDetails">
      ...
      <div class="flex flex-col">
        ...
        <ol class="ml-8 list-decimal">
          <li v-for="slot in event.slots" :key="JSON.stringify(slot)">
